<?php
//=sebus this class may need updating to maintain compatibility with WordPress at some point. Could also try tapping into
// /wp-includes/class-json.php - initial test caused error but could investigate further.
